...
### Added
- Added an optional City ID field to the Property Inspector.

### Changes
- Update weather lookup logic to use cityId when provided, while keeping cityName as the fallback.
